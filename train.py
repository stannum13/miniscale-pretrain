...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--crash-after", type=int, help="hard-exit after this step to test last complete checkpoint")
...
def main() -> None:
    ...
    result = run_training(config, run_id=args.run_id, stop_after=args.stop_after, crash_after=args.crash_after)
